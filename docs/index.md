...
features: # 可选的
  - title: Cli-Plus
    details: Cli-Plus是一款开源的使用Java编写命令行指令的框架，它具有简单、高效、易用等特点。
    link: /pages/2ba02f/
  - title: Spring Websocket
    details: 这是一款支持集群广播的使用netty编写的websocket组件,完美解决websocket和用户单机建立连接无法和整个业务集群通信的问题
    link: /pages/080a71/
  - title: Udp Broadcast
    details: 一款基于netty编写的udp广播组件
    link: /pages/815166/
